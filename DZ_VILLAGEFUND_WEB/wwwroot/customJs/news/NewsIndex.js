$(function () {
        ...
        $.get("/NewsLatter/GetNews", function (JsonResult) {
            setTimeout(function () {
                ...
                $('#JsonTable .edit').unbind().click(function () {
                    window.location.href = "/NewsLatter/FormEditNews?NewsId=" + $(this).attr("data-val");
                });

                // delete
                $('#JsonTable .delete').unbind().click(function () {
                    const TransactionNewsId = $(this).attr("data-val");
                    Swal.fire(
                        {
                            ...
                            if (isConfirm.value == true) {
                                $.get("/NewsLatter/DeleteNews", { "TransactionNewsId": TransactionNewsId }, function (rs) {
                                    if (rs.valid == true) {
