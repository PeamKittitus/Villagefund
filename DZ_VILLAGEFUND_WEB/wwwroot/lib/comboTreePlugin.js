...
;(function ( $, window, document, undefined ) {
  ...
  ComboTree.prototype.createFilterHTMLForMultiSelect = function (){
      return '<input id="' + this.comboTreeId + 'MultiFilter" type="text" class="multiplesFilter form-control" placeholder="ค้นหา"/>';
  }

  ComboTree.prototype.createSelectAllHTMLForMultiSelect = function () {
    return '<label class="selectAll"><input type="checkbox" id="' + this.comboTreeId + 'SelectAll' + '">เลือกทั้งหมด</label>';
  }
